...
<body>
    ...
    <!--header section end -->
    <!-- main section start  -->
    <section class="akc-gallery d-flex text-center align-items-center ">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p class="custom-gtext">GALLERY</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">
                        <p class="galary-color gnew-text">Oslo Colour Festival 2023</p>
                    </div>
                </div>
    ...
    <section class="akc-gallery-section py-5">
        <div class="container">
            <div class="row">
                <div class="col-md-12 py-2">
                    <div class="text-center">
                        <p class="galary-color gnew-text">2022</p>
                    </div>
                </div>
            </div>
            <div class="row ">
