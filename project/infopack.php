...
<body>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcrumb-content">
                        <h2 class="page-title">Information Pack</h2>
    ...
    <div class="our-blog-area section-padding-100">
        <div class="container">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="mailto:info@oslocolourfestival.no">info@oslocolourfestival.no
                                </a></td>
                        </tr>
                        <!-- <tr>
            ...
            <h5>Food</h5></br>
            <ul>
                <li style="list-style: decimal;list-style-position: inside;">Food from outside is not allowed, it can be purchased at Food counters.
                </span></li>
                <li style="list-style: decimal;list-style-position: inside;">If you have any food allergies, check ingredients before buying food.
                </span></li>
            </ul>
            </br></br>
            <h5>Color Celebration</h5></br>
            <ul>
                <li style="list-style: decimal;list-style-position: inside;">Color festival would only be played in a designated area.
                </span></li>
                <li style="list-style: decimal;list-style-position: inside;">No outside Colours will be allowed for playing Color play. Colors to be purchased from the designated area </span></li>
                <li style="list-style: decimal;list-style-position: inside;">Do not use chemical infused or harmful colours</span></li>
                <li style="list-style: decimal;list-style-position: inside;">Don't apply colours in the area near to eyes, nose, mouth and open wounds.
                </span></li>
                <li style="list-style: decimal;list-style-position: inside;">Use of water during color celebration is not allowed</span></li>
                <li style="list-style: decimal;list-style-position: inside;">Kids should be accompanied by parents.
                </span></li>
                <li style="list-style: decimal;list-style-position: inside;">It is recommended to have an extra pair of clothes to participate in color festival.
                </span></li>
            </ul>
            </br></br>
            <h5>General</h5></br>
            <ul>
                ...
                <li style="list-style: decimal;list-style-position: inside;">It is advised to wear shoes all the time 
                </span></li>
                <li style="list-style: decimal;list-style-position: inside;">Consumption of intoxicating substances such as tobacco, alcohol, etc is strictly prohibited in and around the venue.</span></li>
                <li style="list-style: decimal;list-style-position: inside;">We reserve the right to decide and remove any participant deemed physically incapable to be at the event thus preventing him/her from causing greater harm and injury to himself/herself or others.</span></li>
                <li style="list-style: decimal;list-style-position: inside;">For terms and conditions please check: <a href="terms.php"><i class="zmdi zmdi-circle"></i> Terms of use</a></span></li>
            </ul>
            </br>
        </div>
    </div>
