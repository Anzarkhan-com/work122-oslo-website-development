                    ...
                    <div class="classy-menu">
                        ...
                        <div class="classynav">
                            <ul id="nav">
                                ...
                                <li><a href="/index.html#about-holi">Holi</a></li>
    ...
    <div class="our-blog-area section-padding-100">
        <div class="container">
            ...
            <ul>
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>Venue</td>
                            <td>Vallhall Arena, Dronning Margretes vei 11, 0663 Oslo</td>
                        </tr>
                        <tr>
            ...
            <ul>
                ...
                <li style="list-style: decimal;list-style-position: inside;">Parents take full responsibility for their children throughout the event at the venue.</span></li>
                <li style="list-style: decimal;list-style-position: inside;">It is advised to wear shoes all the time (Valhall arena is an Indoor football stadium with an artificial grass surface).</span></li>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single-footer-widget mb-60 wow fadeInUp" data-wow-delay="300ms">
                            <!-- Footer Logo -->
                            <a href="https://www.facebook.com/holiinnorway" class="footer-logo"><img src="assets/img/core-img/logo.png" height="80" width="80" alt=""></a>
                            <p>The Indian community in Norway is bringing together Oslo and Akershus to celebrate the
                                festival of colours.</p>
                            <!-- Social Info -->
                    ...
                    <div class="col-12 col-md-6">
                        <div class="copywrite-text">
                            <p>
                                ...
                                All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by Indians in
                                Norway.
                                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                            </p>
                        </div>
